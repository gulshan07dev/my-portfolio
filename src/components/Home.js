                ...
                <div className="right-section flex">
                    <div className="right-section-heading">
                        <h1>
                            ...
                            Hello, I'm <span>Gulshan Kumar</span>
                    ...
                    <p>
                        I am an aspiring <span>Full stack Web Developer,</span> who is currently working as a <span>Freelancer</span> for National and International Clients.
                    </p>
                ...
                <div className="flex" id="me">
                    ...
                    <div id="profile" className="flex">
                        ...
                        <div className="about-me">
                            <p>
                                Hello! I'm Gulshan Kumar, a self-taught web developer with a passion for creating interactive and dynamic websites. I have experience working with HTML, CSS, JavaScript, and React. I enjoy turning complex problems into simple, beautiful, and intuitive designs.
                            </p>
                            <p>
                                I'm constantly learning new technologies and frameworks to enhance my skills and stay up-to-date with industry trends. I believe in writing clean, organized, and efficient code to build scalable and responsive web applications.
                            </p>
                        </div>
                    </div>
                    {/* about section fold btn   */}
                    <a id="about-section-fold-btn" href="#" onClick={handleFold}>
                        Fold
                    </a>
                </div>
            </section>
